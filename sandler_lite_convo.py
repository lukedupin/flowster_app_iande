...
sandler_convo = {
    ...
    "get_name": {
        ...
        "transitions": [
            {
                "condition": True,
                "when": ScriptState.is_full,
                "next_section": "intention"
            }
        ],
        "data": {
            "global.prospect_name": "Full name of the prospect",
        },
        "knowledge": {
            "DATA_FILE": "file:///tmp/content.md",
        }
    },
    ...
    "intention": {
        "directives": {
            "topic": (
                "Ask the user what they'd like to discuss: article, agent, infinite banking, or life insurance."
            ),
        },
        "prompts": [
            {
                "name": "intro",
                "ai_prompt": (
                    "Say hello to {Global_ProspectName},"
                    "* We can talk about the article.\n"
        ...
        "transitions": [
            {
                "condition": "topic contains 'article' or 'articles'",
                "when": "topic",
                "next_section": "article_state"
            },
            {
                "condition": "topic contains 'agent' or 'contact' or 'reach'",
                "when": "topic",
                "next_section": "agent_state"
            },
            {
                "condition": "topic contains 'infinite banking' or 'banking'",
                "when": "topic",
                "next_section": "infinite_banking_state"
            },
            {
                "condition": "topic contains 'life insurance' or 'insurance'",
                "when": "topic",
                "next_section": "life_insurance_state"
            }
        ],
        "data": {
            "global.prospect_name": "Full name of the prospect",
